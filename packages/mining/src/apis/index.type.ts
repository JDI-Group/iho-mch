...
export interface MinerDailyReward {
  owner: string
  account: string
  fueltank: number
  reward: number
...
export interface GetMinerAccountDailyRewardsPath {
  /** @description address of the miner */
  account: string
}
export interface GetUserOwnerMinersPath {
  /** @description User address */
  owner: string
}
export interface GetUserOwnerDailyRewardsPath {
  /** @description User address */
  owner: string
}
